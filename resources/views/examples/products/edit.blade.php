        ...
        <form action="#">
            ...
            <div class="row">
                <div class="col-4" id="imagem-produto">
                    ...
                    <img src="/images/products/product-example1.jpg" id="imagemProdutoCreate" alt="imagem">
                    <div class="file mt-1">
                        <button type="button" class="btn btn-success select-img" onclick="modalSelectImage()" style="display: none;">Selecionar</button>
                        <button type="button" class="btn btn-danger remove-img" onclick="removeImage('1')">Remover image</button>
                    </div>
                ...
                <div class="col-8" id="formulario">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="product" id="product" placeholder="Nome do produto" required value="Iphone 11">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="d-flex" style="justify-content: space-between">
                        <div class="form-group w-50 mr-2">
                            ...
                            <input type="text" class="form-control" name="price" id="price" data-thousands="." data-decimal="," data-prefix="R$ " placeholder="R$ 0,00" required value="R$ 3.000,00">
                            <script type="text/javascript">$("#price").maskMoney();</script>
                        </div>
                        <div class="form-group w-50 ml-2">
                            <label for="stock">Estoque <span style="color: red;">*</span></label>
                            <input type="number" class="form-control" name="stock" id="stock" placeholder="Quantidade em estoque" required value="10">
                        </div>
                    </div>
                    <div>
                        <label for="description">Descrição</label>
                        <textarea class="form-control" name="description" id="description" aria-label="With textarea" placeholder="Digite aqui...">Descrição do produto aqui. 
                        </textarea>
                    </div>
                    <div class="buttons">
